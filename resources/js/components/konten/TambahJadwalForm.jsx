...
import { ArrowLeft, Calendar, Clock, MapPin, FileText, User, Activity, Save, AlertCircle } from "lucide-react";
        ...
        <div className="flex flex-1 w-full h-full overflow-auto bg-gray-50/50">
            <div className="w-full max-w-4xl mx-auto p-4 md:p-8 flex flex-col gap-6">
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl md:text-3xl font-bold text-gray-800">Tambah Jadwal</h1>
                        <p className="text-gray-500 mt-1">Buat jadwal kegiatan baru untuk anak</p>
                    </div>
                    <button
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {childrenLoading && <p className="text-xs text-gray-500 mt-1 ml-1">Memuat data anak...</p>}
                                </div>
