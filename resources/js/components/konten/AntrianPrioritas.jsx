                ...
                <div className="grid grid-cols-1 gap-4">
                    <div className="bg-white rounded-2xl p-4 md:p-5 shadow-sm border border-gray-100 relative overflow-hidden group hover:shadow-md transition-all">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-xs text-gray-400 mt-1">Patuh konsumsi PMT ≥80% bulan lalu</p>
                        </div>
                    </div>
                </div>
            )}
            ...
            <div className="bg-white rounded-2xl p-4 shadow-sm border border-gray-200">
                <div className="relative w-full">
                    ...
                    <input
                        ...
                        className="block w-full pl-10 pr-3 py-2.5 border border-gray-200 rounded-xl leading-5 bg-gray-50 text-gray-900 placeholder-gray-400 focus:outline-none focus:bg-white focus:ring-2 focus:ring-green-500/20 focus:border-green-500 transition-all sm:text-sm"
                    />
                </div>
            </div>
                            ...
                            >
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div className="w-8 h-8 rounded-full bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-lg shadow-green-200 shrink-0">
                                ...
                                <div className="flex items-center justify-between pt-2 border-t border-gray-50 mt-4">
                                    ...
                                    <button className="text-xs font-semibold text-green-600 bg-green-50 px-3 py-1.5 rounded-lg hover:bg-green-100 transition-colors">
                                        Lihat Detail
                                    </button>
                                </div>
                            </div>
